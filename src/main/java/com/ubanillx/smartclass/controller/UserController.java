...
import com.ubanillx.smartclass.model.dto.user.UserAddRequest;
import com.ubanillx.smartclass.model.dto.user.UserLoginRequest;
import com.ubanillx.smartclass.model.dto.user.UserQueryRequest;
import com.ubanillx.smartclass.model.dto.user.UserRegisterRequest;
import com.ubanillx.smartclass.model.dto.user.UserUpdateMyRequest;
import com.ubanillx.smartclass.model.dto.user.UserUpdateRequest;
...
public class UserController {
    ...
    public BaseResponse<LoginUserVO> userLoginByPhone(@RequestBody UserLoginRequest userLoginRequest, HttpServletRequest request) {
        if (userLoginRequest == null) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR);
        }
